...
class Router
{
    ...
    private function setupPublicRoutes()
    {
        $this->routes = [
            ...
            'property-tax' => '../templates/sample.php',
            'public-health' => '../templates/sample.php',
        ];
    }
